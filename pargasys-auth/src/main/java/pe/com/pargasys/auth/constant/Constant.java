package pe.com.pargasys.auth.constant;
...
public class Constant {
    ...
    public static final String U_INVALID_TOKEN = "Token inválido.";
    public static final String U_INVALID_LOGIN = "Login inválido";
